...
const utils = require("../utils/utils")
        ...
        //approve recruiter
        router.put("/approveuser/:id",(req,resp)=>{


                db.query("UPDATE recruiter_account SET isApproved = 1 where recruiter_id = ?",[req.params.id],(err,data)=>{
        ...
        router.put("/disapproveuser/:id",(req,resp)=>{


                db.query("UPDATE recruiter_account SET isApproved = 0 where recruiter_id = ?",[req.params.id],(err,data)=>{
